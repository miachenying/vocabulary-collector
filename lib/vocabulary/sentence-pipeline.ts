...
Sentence: ${sentence}\n
Selection criteria:\n- Prefer idioms, fixed expressions, phrasal verbs, or concise contextually meaningful reusable expressions whose meaning or usage is not obvious from the individual words.\n- A phrase is NOT worth saving merely because it is common or grammatically natural. Skip routine, literal, compositional actions such as \"submit a report\", \"send an email\", or \"email my manager\".\n- Avoid ordinary collocations, basic words, random noun phrases, and expressions that are only mildly advanced.\n- Do not extract standalone degree/intensity/modifier fragments such as \"not quite\", \"very much\", \"really\", or \"just\".\n- Returning zero expressions is correct and preferred when nothing has meaningful reusable learning value.\n- Every encountered_form must appear verbatim in the sentence.\n- canonical_form should be a concise reusable dictionary-style form; normalize tense/inflection/pronouns when useful.\n- Never return more than 3 expressions.\n
